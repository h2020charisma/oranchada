...
class GenSpe(RC2_Creator):
    ...
    def __init__(self):
        ...
        self.data = None
        self.deltas = '620.9: 16, 795.8: 10, 1001.4: 100, 1031.8: 27, 1155.3: 13, 1450.5: 8, 1583.1: 12, 1602.3: 28, 2852.4: 9, 2904.5: 13, 3054.3: 32'
        self.spe_xmin = 0
        self.spe_xmax = 2000
        self.spe_nbins = 1500
        self.n_spectra = 1
        ...
        gui.comboBox(box, self, 'predefined_spe', sendSelectedValue=True, items=['PST', 'User defined'], callback=self.set_deltas)
    ...
    def multi_process(self):
        ...
        return [spe1.resample_NUDFT_filter(x_range=(self.spe_xmin, self.spe_xmax), xnew_bins=self.spe_nbins)] * self.n_spectra
